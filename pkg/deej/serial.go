...
// pretty much all of the changes to this are entirely yoinked from michaelwschultz's fork on github
// while that fork is primarily to fix windows bugs/issues the serial code rework also fixes the wine/proton bug
// where when closed and the serial connections within wine are released it triggers a complete reconnect
